...
<style>
    ...
    *::after {
    ...
    body {
        ...
        background: linear-gradient(135deg, rgba(30, 29, 31, 1) 0%, #024303 100%);
...
<div class='box'>
    ...
    <div class='box-info'>
        <p><button onclick="" class='b b-info i i-left' title='Back to Sign In'></button>
        <h3>Need Help?</h3>
        </p>
...
<script src="assets/js/bootstrap-table-fr-FR.min.js"></script>
...
<script>
    $(document).ready(function() {
        $("#do_login").click(function() {
            ...
            var formDataLogin = $("#formLogin").serializeArray();
            var action = {
                name: "action",
                value: "LOGIN",
            };
            formDataLogin.push(action);
